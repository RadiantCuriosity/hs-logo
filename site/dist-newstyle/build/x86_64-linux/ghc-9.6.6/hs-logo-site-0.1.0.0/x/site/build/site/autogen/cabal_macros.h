...
/* package hs-logo-site-0.1.0.0 */
#ifndef VERSION_hs_logo_site
#define VERSION_hs_logo_site "0.1.0.0"
#endif /* VERSION_hs_logo_site */
#ifndef MIN_VERSION_hs_logo_site
#define MIN_VERSION_hs_logo_site(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hs_logo_site */
...
/* package hakyll-4.16.4.0 */
#ifndef VERSION_hakyll
#define VERSION_hakyll "4.16.4.0"
...
#define CURRENT_COMPONENT_ID "hs-logo-site-0.1.0.0-inplace-site"
